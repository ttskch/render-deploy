...
const run = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const client = new http_client_1.HttpClient('ttskch/render-deploy', [
        new auth_1.BearerCredentialHandler(apiKey),
    ]);
    const { result: createResult } = yield client.postJson(`https://api.render.com/v1/services/${serviceId}/deploys`, undefined, {
    ...
    while (true) {
        yield new Promise((resolve) => setTimeout(resolve, interval * 1000)); // wait for interval
        const { result: checkResult } = yield client.getJson(`https://api.render.com/v1/services/${serviceId}/deploys/${deployId}`);
